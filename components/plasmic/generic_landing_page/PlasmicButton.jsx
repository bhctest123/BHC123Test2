...
import sty from "./PlasmicButton.module.css"; // plasmic-import: UKkIqo7bx-OmDK/css
import AppleIcon from "./icons/PlasmicIcon__Apple"; // plasmic-import: qpuapd4-85WH4h/icon
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <AppleIcon
                className={classNames(projectcss.all, sty.svg__fXew)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <AppleIcon
                className={classNames(projectcss.all, sty.svg__sd66D)}
                role={"img"}
              />
            ),
