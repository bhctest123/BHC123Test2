...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: 4Fi6GOsy0UY7Qq/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___99U8K)}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__vdE1)}
      >
        <p.PlasmicImg
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox___8T63K)}
        >
          <div className={classNames(projectcss.all, sty.freeBox__eRMj3)}>
            {p.renderPlasmicSlot({
