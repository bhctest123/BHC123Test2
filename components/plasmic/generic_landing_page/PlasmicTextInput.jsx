...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: ytfeUyik6kW3RZ/css
import SearchIcon from "./icons/PlasmicIcon__Search"; // plasmic-import: OONDIjAyjGOM9z/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchIcon
                className={classNames(projectcss.all, sty.svg___9NDjR)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <CheckIcon
                className={classNames(projectcss.all, sty.svg__tl)}
                role={"img"}
              />
            ),
